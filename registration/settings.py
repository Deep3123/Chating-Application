...
SECRET_KEY = 'django-insecure-7u$1#o6@8-v34p+dz!5-jr=bwdu6e9-#(77^tjjf9zffz32&*p'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',         # Database file will be created in the project directory
    }
}
